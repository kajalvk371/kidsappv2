...
export default function page() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-yellow-50 p-4 sm:p-6">
      <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-yellow-600 text-center">
        About Our Fun Learning App!
      </h1>
      <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8 max-w-lg sm:max-w-4xl text-center">
